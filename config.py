...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://userbot:userbot@cluster0.iweqz.mongodb.net/test?retryWrites=true&w=majority")
#your database name
...
ADMIN_LIST = os.environ.get("ADMINS", "5983189506").split()
